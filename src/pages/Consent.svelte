<script>
  ...
  const consent = `We need your consent to proceed. The following material explains this research study. We want you to understand what you are being asked to do and what risks and benefits, if any, are associated with the study. Consent with this form will indicate that you have been informed about the study and that you want to participate.<br/><br/>
    ...
    If you decide to take part in this study, you will be asked to listen multiple 2 minute recordings and identify complete thoughts within each recording. You will be asked to complete a minimum of <strong>5 audio recordings</strong>, with the possibility of completing additional audio recordings for bonus payments, at the rate of $1 per additional recording.<br/><br/>

    Your responses will will be collected in an anonymous fashion such that no identifying information will be stored alongside any response you make during the task. Identifying information will not be used in any presentation or paper written about this project and such presentations will represent the aggregation of data from groups of people. <br><br> <strong>Do you understand and consent to these terms?</strong><br/>
